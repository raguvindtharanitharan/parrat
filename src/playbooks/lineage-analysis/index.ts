...
export const lineageAnalysisPlaybook = definePlaybook({
  ...
  async run(input: LineageAnalysisInput, ctx: PlaybookContext): Promise<LineageAnalysisOutput> {
